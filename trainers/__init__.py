...
from .resampling import ResamplingTrainer
...
from .raccon import RaCConTrainer
from .resampling import ResamplingTrainer
...
method_to_trainer = {
    ...
    "dfr": DFRTrainer,
    "raccon": RaCConTrainer,
    "resampling": ResamplingTrainer,
    "reweighting": ReweightingTrainer,
    "sebra": SebraTrainer,
}
